...
wg_dirs = {
    ...
    "workspaces": "../applications/admission-webhook/upstream/overlays ../applications/centraldashboard/overlays ../applications/notebooks-v1/upstream ../applications/profiles/upstream/overlays",
