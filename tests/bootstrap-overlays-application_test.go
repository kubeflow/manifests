...
`)
	th.writeF("/manifests/admission-webhook/bootstrap/overlays/application/params.yaml", `
varReference:
- path: metadata/name
  kind: Application
...
- path: spec/template/metadata/labels/app.kubernetes.io\/instance
  kind: StatefulSet
`)
	th.writeF("/manifests/admission-webhook/bootstrap/overlays/application/params.env", `
generateName=
`)
