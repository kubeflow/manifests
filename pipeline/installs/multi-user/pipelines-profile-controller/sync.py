...
mlpipeline_minio_access_key = base64.b64encode(bytes(os.environ.get("MINIO_ACCESS_KEY"), 'utf-8'))
mlpipeline_minio_secret_key = base64.b64encode(bytes(os.environ.get("MINIO_SECRET_KEY"), 'utf-8'))
