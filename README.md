...
| Component | Local Manifests Path | Upstream Revision |
| - | - | - |
| Istio | common/istio-1-26 | [1.26.1](https://github.com/istio/istio/releases/tag/1.26.1) |
...
kustomize build common/istio-1-26/istio-crds/base | kubectl apply -f -
kustomize build common/istio-1-26/istio-namespace/base | kubectl apply -f -
...
# kustomize build common/istio-1-26/istio-install/overlays/gke | kubectl apply -f -
...
kustomize build common/istio-1-26/cluster-local-gateway/base | kubectl apply -f -
```
...
```sh
kustomize build common/istio-1-26/kubeflow-istio-resources/base | kubectl apply -f -
```
