...
* use `oauth2-proxy` overlay for istio-install
  ```
  # from
  - ../common/istio-1-21/istio-install/base
  # to
  - ../common/istio-1-21/istio-install/overlays/oauth2-proxy
  ```
...
@@ -38,11 +38,11 @@ resources:
 # Istio
 - ../common/istio-1-21/istio-crds/base
 - ../common/istio-1-21/istio-namespace/base
-- ../common/istio-1-21/istio-install/base
-# OIDC Authservice
-- ../common/oidc-client/oidc-authservice/base
+- ../common/istio-1-21/istio-install/overlays/oauth2-proxy
