...
func writeCiPipelineRunOverlaysManifestsRepoResource(th *KustTestHarness) {
	th.writeF("/manifests/ci/ci-pipeline-run/overlays/manifests-repo-resource/pipeline-resource.yaml", `
...
`)
	th.writeF("/manifests/ci/ci-pipeline-run/overlays/manifests-repo-resource/params.yaml", `
varReference:
- path: spec/params/value
  kind: PipelineResource
`)
	th.writeF("/manifests/ci/ci-pipeline-run/overlays/manifests-repo-resource/pipeline-run-patch.yaml", `
- op: add
  path: /spec/resources/-
  value:
    name: manifests
    resourceRef:
      name: manifests
`)
	th.writeF("/manifests/ci/ci-pipeline-run/overlays/manifests-repo-resource/params.env", `
manifests_repo_revision=master
manifests_repo_url=git@github.com:kubeflow/manifests.git
`)
	th.writeK("/manifests/ci/ci-pipeline-run/overlays/manifests-repo-resource", `
...
func TestCiPipelineRunOverlaysManifestsRepoResource(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/ci/ci-pipeline-run/overlays/manifests-repo-resource")
	writeCiPipelineRunOverlaysManifestsRepoResource(th)
	...
	targetPath := "../ci/ci-pipeline-run/overlays/manifests-repo-resource"
	fsys := fs.MakeRealFS()
