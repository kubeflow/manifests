...
func writeKatibOperatorsOverlaysIstio(th *KustTestHarness) {
	th.writeF("/manifests/katib-v1alpha2/katib-operators/overlays/istio/katib-ui-virtual-service.yaml", `
  ...
  - match:
    ...
    - destination:
        ...
        port:
          number: 80
`)
	th.writeF("/manifests/katib-v1alpha2/katib-operators/overlays/istio/params.yaml", `
varReference:
- path: spec/http/route/destination/host
  kind: VirtualService
`)
	th.writeK("/manifests/katib-v1alpha2/katib-operators/overlays/istio", `
...
func TestKatibOperatorsOverlaysIstio(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/katib-v1alpha2/katib-operators/overlays/istio")
	writeKatibOperatorsOverlaysIstio(th)
	m, err := th.makeKustTarget().MakeCustomizedResMap()
	if err != nil {
		t.Fatalf("Err: %v", err)
	}
	targetPath := "../katib-v1alpha2/katib-operators/overlays/istio"
	fsys := fs.MakeRealFS()
