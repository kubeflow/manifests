...
spec:
  ...
  addOwnerRef: true
`)
	th.writeF("/manifests/knative/knative-serving-install/overlays/application/params.yaml", `
varReference:
- path: metadata/name
  kind: Application
...
- path: spec/template/metadata/labels/app.kubernetes.io\/instance
  kind: Deployment
`)
	th.writeF("/manifests/knative/knative-serving-install/overlays/application/params.env", `
generateName=
`)
...
- application.yaml
configMapGenerator:
- name: knative-serving-install-app-parameters
  env: params.env
vars:
- name: generateName
  objref:
