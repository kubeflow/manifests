...
func writeApiServiceOverlaysObjectStore(th *KustTestHarness) {
	th.writeF("/manifests/pipeline/api-service/overlays/object-store/config-map.yaml", `
...
`)
	th.writeF("/manifests/pipeline/api-service/overlays/object-store/params.yaml", `
varReference:
- path: data
  kind: ConfigMap
`)
	th.writeF("/manifests/pipeline/api-service/overlays/object-store/params.env", `
mysqlHost=
mysqlUser=
mysqlPassword=
`)
	th.writeK("/manifests/pipeline/api-service/overlays/object-store", `
...
func TestApiServiceOverlaysObjectStore(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/pipeline/api-service/overlays/object-store")
	writeApiServiceOverlaysObjectStore(th)
	...
	targetPath := "../pipeline/api-service/overlays/object-store"
	fsys := fs.MakeRealFS()
