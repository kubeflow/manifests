...
func writeIstioOverlaysIngressgatewaySelfSignedCert(th *KustTestHarness) {
	th.writeF("/manifests/istio/istio/overlays/ingressgateway-self-signed-cert/certificate.yaml", `
...
spec:
  ...
  issuerRef:
    ...
    kind: ClusterIssuer
`)
	th.writeF("/manifests/istio/istio/overlays/ingressgateway-self-signed-cert/params.yaml", `
varReference:
- path: spec/domains
  kind: Certificate
`)
	th.writeF("/manifests/istio/istio/overlays/ingressgateway-self-signed-cert/params.env", `
domain=example.org
`)
	th.writeK("/manifests/istio/istio/overlays/ingressgateway-self-signed-cert", `
...
func TestIstioOverlaysIngressgatewaySelfSignedCert(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/istio/istio/overlays/ingressgateway-self-signed-cert")
	writeIstioOverlaysIngressgatewaySelfSignedCert(th)
	...
	targetPath := "../istio/istio/overlays/ingressgateway-self-signed-cert"
	fsys := fs.MakeRealFS()
