...
func writeIstioOverlaysApplication(th *KustTestHarness) {
	th.writeF("/manifests/istio/istio/overlays/application/application.yaml", `
...
spec:
  ...
  descriptor:
    ...
    - description: About
      url: "https://istio.io"
`)
	th.writeF("/manifests/istio/istio/overlays/application/params.yaml", `
varReference:
- path: metadata/name
  kind: Application
- path: spec/selector/matchLabels/app.kubernetes.io\/instance
  kind: Application
`)
	th.writeF("/manifests/istio/istio/overlays/application/params.env", `
generateName=
`)
	th.writeK("/manifests/istio/istio/overlays/application", `
...
func TestIstioOverlaysApplication(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/istio/istio/overlays/application")
	writeIstioOverlaysApplication(th)
	...
	targetPath := "../istio/istio/overlays/application"
	fsys := fs.MakeRealFS()
