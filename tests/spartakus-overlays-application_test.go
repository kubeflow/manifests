...
`)
	th.writeF("/manifests/common/spartakus/overlays/application/params.yaml", `
varReference:
- path: metadata/name
  kind: Application
...
- path: spec/template/metadata/labels/app.kubernetes.io\/instance
  kind: Deployment
`)
	th.writeF("/manifests/common/spartakus/overlays/application/params.env", `
generateName=
`)
