...
func writeCiPipelineRunOverlaysKubeflowRepoResource(th *KustTestHarness) {
	th.writeF("/manifests/ci/ci-pipeline-run/overlays/kubeflow-repo-resource/pipeline-resource.yaml", `
...
`)
	th.writeF("/manifests/ci/ci-pipeline-run/overlays/kubeflow-repo-resource/params.yaml", `
varReference:
- path: spec/params/value
  kind: PipelineResource
`)
	th.writeF("/manifests/ci/ci-pipeline-run/overlays/kubeflow-repo-resource/pipeline-run-patch.yaml", `
- op: add
  path: /spec/resources/-
  value:
    name: kubeflow
    resourceRef:
      name: kubeflow
`)
	th.writeF("/manifests/ci/ci-pipeline-run/overlays/kubeflow-repo-resource/params.env", `
kubeflow_repo_revision=master
kubeflow_repo_url=git@github.com:kubeflow/kubeflow.git
`)
	th.writeK("/manifests/ci/ci-pipeline-run/overlays/kubeflow-repo-resource", `
...
func TestCiPipelineRunOverlaysKubeflowRepoResource(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/ci/ci-pipeline-run/overlays/kubeflow-repo-resource")
	writeCiPipelineRunOverlaysKubeflowRepoResource(th)
	...
	targetPath := "../ci/ci-pipeline-run/overlays/kubeflow-repo-resource"
	fsys := fs.MakeRealFS()
