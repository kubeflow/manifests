...
- **Q:** Can I use earlier version of Kustomize with Kubeflow manifests? \
  **A:** The manual installation instructions work with Kustomize 5.0.3+. To use the one-liner installation you'll need to comment out the `sortOptions` section in the `example/kustomization.yaml`.
