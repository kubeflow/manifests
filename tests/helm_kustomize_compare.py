...
if __name__ == "__main__":
    ...
    if component not in ["katib", "model-registry", "kserve-models-web-app", "kubeflow-pipelines"]:
        print(f"ERROR: Unknown component: {component}")
        print("Supported components: katib, model-registry, kserve-models-web-app, kubeflow-pipelines")
        sys.exit(1)
