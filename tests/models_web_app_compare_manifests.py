...
def normalize_manifest(manifest: Dict) -> Dict:
    ...
    # Normalize Kustomize references
...
def compare_manifests(kustomize_file: str, helm_file: str, scenario: str) -> bool:
    ...
    expected_helm_extras = set()
    if scenario == "base":
        expected_helm_extras = {"AuthorizationPolicy/kserve-models-web-app"}
...
if __name__ == "__main__":
    if len(sys.argv) < 4:
        print("Usage: python models_web_app_compare_manifests.py <kustomize_file> <helm_file> <scenario>")
        sys.exit(1)
