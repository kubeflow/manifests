...
func writeSeldonCoreOperatorOverlaysIstio(th *KustTestHarness) {
	th.writeF("/manifests/seldon/seldon-core-operator/overlays/istio/seldon-operator-controller-manager-statefulset.yaml", `
apiVersion: apps/v1
kind: StatefulSet
metadata:
...
`)
	th.writeK("/manifests/seldon/seldon-core-operator/overlays/istio", `
...
func TestSeldonCoreOperatorOverlaysIstio(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/seldon/seldon-core-operator/overlays/istio")
	writeSeldonCoreOperatorOverlaysIstio(th)
	...
	targetPath := "../seldon/seldon-core-operator/overlays/istio"
	fsys := fs.MakeRealFS()
