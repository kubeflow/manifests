...
`)
	th.writeF("/manifests/tf-training/tf-job-crds/overlays/application/params.yaml", `
varReference:
- path: metadata/name
  kind: Application
- path: spec/selector/matchLabels/app.kubernetes.io\/instance
  kind: Application
`)
	th.writeF("/manifests/tf-training/tf-job-crds/overlays/application/params.env", `
generateName=
`)
...
- application.yaml
configMapGenerator:
- name: tf-job-crds-app-parameters
  env: params.env
vars:
- name: generateName
  objref:
...
commonLabels:
  ...
  app.kubernetes.io/component: tf-training
