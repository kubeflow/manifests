...
5. Install Istio
   ```sh
   kubectl apply -k ../../common/istio-cni-1-24/istio-crds/base
   kubectl apply -k ../../common/istio-cni-1-24/istio-namespace/base
   kubectl apply -k ../../common/istio-cni-1-24/istio-install/base
   ```
6. Install knative
   ```sh
   kubectl apply -k ../../common/knative/knative-serving/overlays/gateways
   kubectl apply -k ../../common/istio-cni-1-24/cluster-local-gateway/base
   kubectl apply -k ../../common/istio-cni-1-24/kubeflow-istio-resources/base
