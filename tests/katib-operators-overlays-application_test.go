...
func writeKatibOperatorsOverlaysApplication(th *KustTestHarness) {
	th.writeF("/manifests/katib-v1alpha2/katib-operators/overlays/application/application.yaml", `
...
spec:
  ...
  addOwnerRef: true
`)
	th.writeK("/manifests/katib-v1alpha2/katib-operators/overlays/application", `
...
func TestKatibOperatorsOverlaysApplication(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/katib-v1alpha2/katib-operators/overlays/application")
	writeKatibOperatorsOverlaysApplication(th)
	m, err := th.makeKustTarget().MakeCustomizedResMap()
	if err != nil {
		t.Fatalf("Err: %v", err)
	}
	targetPath := "../katib-v1alpha2/katib-operators/overlays/application"
	fsys := fs.MakeRealFS()
