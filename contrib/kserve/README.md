...
5. Install Istio
   ```sh
   kubectl apply -k ../../common/istio-1-21/istio-crds/base
   kubectl apply -k ../../common/istio-1-21/istio-namespace/base
   kubectl apply -k ../../common/istio-1-21/istio-install/base
   ```
6. Install knative
   ```sh
   kubectl apply -k ../../common/knative/knative-serving/overlays/gateways
   kubectl apply -k ../../common/istio-1-21/cluster-local-gateway/base
   kubectl apply -k ../../common/istio-1-21/kubeflow-istio-resources/base
   ```
7. Install kserve
   ```sh
   make install-kserve
