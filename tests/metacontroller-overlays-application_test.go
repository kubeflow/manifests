...
func writeMetacontrollerOverlaysApplication(th *KustTestHarness) {
	th.writeF("/manifests/metacontroller/overlays/application/application.yaml", `
...
`)
	th.writeF("/manifests/metacontroller/overlays/application/params.yaml", `
varReference:
- path: metadata/name
  kind: Application
...
- path: spec/template/metadata/labels/app.kubernetes.io\/instance
  kind: StatefulSet
`)
	th.writeF("/manifests/metacontroller/overlays/application/params.env", `
generateName=
`)
	th.writeK("/manifests/metacontroller/overlays/application", `
...
- application.yaml
configMapGenerator:
- name: metacontroller-app-parameters
  env: params.env
vars:
- name: generateName
  objref:
...
commonLabels:
  ...
  app.kubernetes.io/component: metacontroller
...
func TestMetacontrollerOverlaysApplication(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/metacontroller/overlays/application")
	writeMetacontrollerOverlaysApplication(th)
	...
	targetPath := "../metacontroller/overlays/application"
	fsys := fs.MakeRealFS()
