...
func writeSpartakusOverlaysIstio(th *KustTestHarness) {
	th.writeF("/manifests/common/spartakus/overlays/istio/deployment.yaml", `
apiVersion: apps/v1
kind: Deployment
metadata:
...
`)
	th.writeK("/manifests/common/spartakus/overlays/istio", `
...
func TestSpartakusOverlaysIstio(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/common/spartakus/overlays/istio")
	writeSpartakusOverlaysIstio(th)
	...
	targetPath := "../common/spartakus/overlays/istio"
	fsys := fs.MakeRealFS()
