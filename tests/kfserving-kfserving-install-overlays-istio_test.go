...
func writeKfservingInstallOverlaysIstio(th *KustTestHarness) {
	th.writeF("/manifests/kfserving/kfserving-install/overlays/istio/statefulset.yaml", `
apiVersion: apps/v1
kind: StatefulSet
metadata:
...
`)
	th.writeK("/manifests/kfserving/kfserving-install/overlays/istio", `
...
func TestKfservingInstallOverlaysIstio(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/kfserving/kfserving-install/overlays/istio")
	writeKfservingInstallOverlaysIstio(th)
	...
	targetPath := "../kfserving/kfserving-install/overlays/istio"
	fsys := fs.MakeRealFS()
