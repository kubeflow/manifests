...
func writeKatibV1Alpha2MetricsCollectorBase(th *KustTestHarness) {
...
func TestKatibV1Alpha2MetricsCollectorBase(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/katib-v1alpha2/metrics-collector/base")
	writeKatibV1Alpha2MetricsCollectorBase(th)
