...
manifests_repo_url=https://github.com/kubeflow/manifests
`)
...
configMapGenerator:
- name: manifests-repo-resource-parameters
  env: params.env
vars:
...
spec:
  ...
  resources:
    requests:
      storage: 1Gi
`)
	th.writeF("/manifests/ci/ci-pipeline-run/base/secret.yaml", `
---
apiVersion: v1
kind: Secret
metadata:
...
type: Opaque
data:
  ci-secret.json: 
`)
