...
BRANCH_NAME=${BRANCH_NAME:=synchronize-${COMPONENT_NAME}-manifests-${MANIFESTS_VERSION?}}
MANIFESTS_DIRECTORY=$(dirname $SCRIPT_DIRECTORY)
SOURCE_MANIFESTS_PATH="install/${MANIFESTS_VERSION}"
...
DESTINATION_TEXT="\[${MANIFESTS_VERSION}\](https://github.com/${REPOSITORY_NAME}/releases/tag/${MANIFESTS_VERSION}/install/${MANIFESTS_VERSION})"
...
commit_changes "$MANIFESTS_DIRECTORY" "Update ${REPOSITORY_NAME} manifests from ${MANIFESTS_VERSION}" "$MANIFESTS_DIRECTORY"
