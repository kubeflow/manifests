...
func writeIstioCrdsOverlaysApplication(th *KustTestHarness) {
	th.writeF("/manifests/istio/istio-crds/overlays/application/application.yaml", `
...
spec:
  ...
  descriptor:
    ...
    - description: About
      url: "https://istio.io/"
`)
	th.writeF("/manifests/istio/istio-crds/overlays/application/params.yaml", `
varReference:
- path: metadata/name
  kind: Application
- path: spec/selector/matchLabels/app.kubernetes.io\/instance
  kind: Application
`)
	th.writeF("/manifests/istio/istio-crds/overlays/application/params.env", `
generateName=
`)
	th.writeK("/manifests/istio/istio-crds/overlays/application", `
...
- application.yaml
configMapGenerator:
- name: istio-crds-app-parameters
  env: params.env
vars:
- name: generateName
  objref:
...
func TestIstioCrdsOverlaysApplication(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/istio/istio-crds/overlays/application")
	writeIstioCrdsOverlaysApplication(th)
	...
	targetPath := "../istio/istio-crds/overlays/application"
	fsys := fs.MakeRealFS()
